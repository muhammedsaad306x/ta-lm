const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/carousel-vendor-2d6kTBOk.css"])))=>i.map(i=>d[i]);
import{j as e}from"./map-vendor-bFKnpCbR.js";import{R as g,r as te}from"./form-vendor-2tEkjfrN.js";import{u as ne,k as se}from"./tanstack-vendor-BIBkAdy1.js";import{p as ie,ba as oe,L as ae,d as re,h as le,C as ce,T as de,f as me,bb as L}from"./index-B9j8TIkH.js";import{B as xe}from"./Breadcrumbs-CP2ARXTu.js";import{T as he,a as ue,b as pe,c as d,d as fe}from"./NominatedCasesList.styles-Vc3j6d7f.js";import{u as ge}from"./useFormattedDate-Hs2Ik4Z8.js";import{z as je}from"./react-icons-vendor-CvqjQV9E.js";import{_ as K}from"./media-vendor-C8E2tzc3.js";import{d as o}from"./ui-vendor-DkFBY_P_.js";import{u as Z}from"./vendor-Dpb4irXk.js";import"./carousel-vendor-C-zzQswU.js";let M=null,z=null;const ye=async()=>(M||(M=K(()=>import("./media-vendor-C8E2tzc3.js").then(a=>a.b),__vite__mapDeps([0]))),(await M).default),ve=async()=>(z||(z=K(()=>import("./media-vendor-C8E2tzc3.js").then(a=>a.j),__vite__mapDeps([0]))),(await z).jsPDF);function be({targetRef:t,fileName:a="document",orientation:s="p",format:j="a4",margin:i=10,unit:y="mm",scale:h=2,onBeforeCapture:v,onAfterCapture:b,children:$}){const[c,P]=g.useState(!1),p=g.useCallback(async()=>{if(!(!t||!t.current))try{P(!0),v&&await v();const[I,{jsPDF:k}]=await Promise.all([ye(),ve()]),S=t.current,n=await I(S,{scale:h,useCORS:!0,backgroundColor:"#ffffff",windowWidth:S.scrollWidth}),m=n.toDataURL("image/png"),C=k,u=new C({orientation:s,unit:y,format:j}),w=u.internal.pageSize.getWidth(),A=u.internal.pageSize.getHeight(),H=w-i*2,N=A-i*2,f=H,x=n.height*f/n.width;if(x<=N)u.addImage(m,"PNG",i,i,f,x,void 0,"FAST");else{let r=i,D=x;const l=document.createElement("canvas"),T=l.getContext("2d"),U=f/n.width,X=Math.floor(N/U);let W=0;for(;D>0;){const E=Math.min(X,n.height-W);l.width=n.width,l.height=E,T.clearRect(0,0,l.width,l.height),T.drawImage(n,0,W,n.width,E,0,0,n.width,E);const ee=l.toDataURL("image/png");r!==i&&(u.addPage(),r=i);const q=E*U;u.addImage(ee,"PNG",i,r,f,q,void 0,"FAST"),W+=E,D-=q,D>0&&u.addPage()}}u.save(`${a}.pdf`),b&&b()}catch(I){console.error("PDF download failed:",I)}finally{P(!1)}},[a,j,i,b,v,s,h,t,y]);return typeof $=="function"?$({downloading:c,download:p}):e.jsx("button",{onClick:p,disabled:c,children:c?"Preparing PDF…":"Download PDF"})}const $e="/assets/invoice_logo-Dx18k7sm.svg",we="/assets/invoice_logo_footer-B_zA7ekf.svg",V="#0a67a3",O="#cfd8e3",R="#0f4c77",Pe="#0b59a1",Ie=o.div`
  width: 900px;
  background: #ffffff;
  color: #000;
